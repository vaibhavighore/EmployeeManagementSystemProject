...
<c:param name="title" value="View Profile page"></c:param>
</c:import>
...
%>
<form action="AdminController?page=viewProfile" method="post">
...
<div class="form-group">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="password" name="password" readonly="password" value="<%=rs.getString("password")%>">
