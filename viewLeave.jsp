<%@page import="code.microsystem.Entity.LeaveEmp"%>
...
<div class="col-lg-6">
<%
List<LeaveEmp> empList = AdminService.viewAllLeave();
int sno = 1;
%>
<c:set var="emp" value="<%=empList %>"></c:set>
<h4>View All Leave Employee Details</h4>
<hr>
...
<td scope="row">${e.fdate}</td>
<td scope="row">${e.tdate}</td>
<th><a href="changeStatus.jsp?id=${e.id}">Change Status</a></th>
